...
class CreateFitRequest(marshmallow.Schema):
    ...
    init_radius: fields.Number = fields.Number()
    ...
    stepsize: fields.Number = fields.Number()
    stepsize_jitter: fields.Number = fields.Number()
    max_depth = fields.Integer(validate=validate.Range(min=0))
    delta: fields.Number = fields.Number()
    gamma: fields.Number = fields.Number()
    kappa: fields.Number = fields.Number()
    t0: fields.Number = fields.Number()
